...
def to_pdf_bytes(title: str, text: str) -> bytes:
    ...
    # very simple markdown-to-text: remove hashes/asterisks
...
def is_night_chicago():
    ...
    # Simple heuristic: night between 7:00pm and 7:00am
...
with st.sidebar:
    ...
    dm_mode = st.radio("Dark Mode", ["Auto (by clock)", "Light", "Dark"], index=0,
                       help="Auto uses your America/Chicago clock: Dark after 7pm until 7am.")
    # Auto-refresh
...
# Tab 9: Legal & Disclosures (static content you supplied)
with tabs[8]:
...
{org_name} respects your privacy. This app is designed to minimize personal data collection.
